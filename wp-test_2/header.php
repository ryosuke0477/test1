...
<body <?php body_class(); ?>>
    ...
    <header class="header">
        <a href="<?php echo home_url(); ?>" class="header__logo">Tecool</a>
        <nav class="header-nav pc">
            <ul class="header-nav__ul">
                <li class="header-nav__list"><a href="<?php echo get_category_link(16); ?>">Topics</a></li>
                <li class="header-nav__list"><a href="<?php echo get_post_type_archive_link('styles'); ?>">Style</a></li>
